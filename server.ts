...
function getServerDb() {
  if (!serverDbInstance) {
    try {
      ...
      const dbId = firebaseConfig.firestoreDatabaseId && firebaseConfig.firestoreDatabaseId !== 'ai-studio-a28a4e79-aaed-4397-8c2e-35ca638d50f7'
        ? firebaseConfig.firestoreDatabaseId
        : '(default)';
      serverDbInstance = getAdminFirestore(firebaseAdminApp, dbId);
    } catch (err: any) {
      console.warn('[SERVER] Warning initializing Firebase Admin:', err.message);
      return null;
    }
  }
